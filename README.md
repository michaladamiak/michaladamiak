...
Watch AI learn to play Google Chrome dinosaur game using deep reinforcement learning. So far the learning is quite slow, I'm working on adjusting configuration to improve the process.
